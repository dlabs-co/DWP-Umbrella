...
"AT+CWMODE=1",                                                       //modo cliente
  ...
  "AT+CIPSTA=\"192.168.11.45\",\"192.168.1.1\",\"255.255.255.0\"",  // IP static, Gateway, Netmask
  "AT+CIFSR",                                                        // Muestra IP
...
void hardReset()
{
  pinMode(pinWifiRst,OUTPUT);
  digitalWrite(pinWifiRst,LOW);
  delay(500);
  digitalWrite(pinWifiRst,HIGH);
  delay(1000);
}
